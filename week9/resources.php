...
<div class="container">
    ...
    <h1 class="mt-5">Resources Used:</h1><hr>
    ...
    <br>
    <small>Idk why you're here. Its just the same as the modal.</small>
    <small>You bored? <a href="index.php">Click here to go back: </a></small>
</div>
